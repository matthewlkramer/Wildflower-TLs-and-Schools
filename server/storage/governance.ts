import { GOVERNANCE_DOCS_FIELDS as GDF, _990S_FIELDS as N9F, SCHOOL_NOTES_FIELDS as SNF } from "@shared/airtable-schema";
import type { GovernanceDocument, CharterGovernanceDocument, Charter990, CharterNote, Tax990 } from "@shared/schema";
import { createdAt, updatedAt, firstAttachment } from "./util";
