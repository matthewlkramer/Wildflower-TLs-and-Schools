...
export class SimpleAirtableStorage implements IStorage {
  ...
  private transformEducatorRecord(record: any): Educator {
    ...
    return {
      ...
      startupStageForActiveSchool: fields["Stage_Status for Active School"] || undefined,
  ...
  private transformSchoolRecord(record: any): School {
    ...
    return {
      ...
      currentPhysicalAddress: fields['Current Physical Address?'] || '',
      currentMailingAddress: fields['Current Mailing Address?'] || '',
