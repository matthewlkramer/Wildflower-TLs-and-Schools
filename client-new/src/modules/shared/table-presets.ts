...
export const TABLE_PRESETS = {
  ...
  // Generic preset for Ops Guide tab: Advice Givers linked to a school
  advice: {
    readSource: { table: 'advice', fkColumn: 'school_id' },
    writeDefaults: { table: 'advice', pkColumn: 'id' },
    columns: cols('advice'),
    rowActions: ['view_in_modal', 'archive'] as const,
    tableActions: [] as const,
    tableActionLabels: [] as const,
  },
  ...
  schoolAdvice: {
    ...
    columns: cols('advice'),
    rowActions: ['inline_edit', 'view_in_modal', 'archive'] as const,
    tableActions: ['addAdvice'] as const,
    tableActionLabels: ['Add Advice'] as const,
  },
} as const;
