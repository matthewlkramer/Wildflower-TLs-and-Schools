...
export const TABLE_LIST_PRESETS = {
  ...
  educators: {
    title: 'Educators',
    orderBy: { column: 'is_active', ascending: false } as const,
    cardLimit: 50,
    ...
    columns: [
      { field: 'school_name', label: 'School Name', visibility: 'suppress' }, // Hidden field for association header
      ...
      { field: 'race_ethnicity', label: 'Race/ethnicity', lookupTable: 'zref_race_and_ethnicity', listLayout: 'body' },
      { field: 'gender', lookupTable: 'zref_genders', listLayout: 'body' },
      { field: 'primary_phone', label: 'Phone', showLabel: false, listLayout: 'body' },
      { field: 'primary_email', label: 'Email', showLabel: false, listLayout: 'body' },
      { field: 'has_montessori_cert', label: 'Montessori Cert?', listLayout: 'body' },
      { field: 'is_active', label: 'Active?', listLayout: 'body' },
    ] as const,
  ...
  schools: {
    ...
    writeDefaults: { table: 'people_roles_associations', pkColumn: 'id' },
    columns: [
      { field: 'full_name', label: 'Person Name', visibility: 'suppress' }, // Hidden field for association header
      { field: 'logo', type: 'attachment', listLayout: 'logo'},
      { field: 'school_name', label: 'School', listLayout: 'title'},
      { field: 'geography', label: 'Geography', listLayout: 'subtitle' },
      { field: 'stage_status', label: 'Stage/Status', update: 'no' , listLayout: 'body'},
      { field: 'governance_model', label: 'Model', listLayout: 'body' },
      { field: 'membership_status', label: 'Member?', listLayout: 'body' },
      { field: 'ages_served', label: 'Ages', listLayout: 'body' },
      { field: 'role', lookupTable: 'zref_roles', listLayout: 'body' },
      { field: 'open_date', label: 'Open Date', listLayout: 'body'},
      { field: 'projected_open', label: 'Projected Open', listLayout: 'body', visibleIf: { eq: { column: 'open_date', value: 'null' } } },
      { field: 'start_date', listLayout: 'body' },
      { field: 'end_date', listLayout: 'body' },
      { field: 'is_active', label: 'Active?', listLayout: 'body' },
  ...
  advice: {
    ...
    sourceTable: 'advice',
    columns: [
      { field: 'stage', label: 'Stage', listLayout: 'subtitle' },
      { field: 'advice_giver_people_id', label: 'Advice Giver (TL)', lookupTable: 'people', listLayout: 'title'},
      { field: 'advice_giver_guide_id', label: 'Advice Giver (Partner)', lookupTable: 'guides', listLayout: 'title'},
      { field: 'advice_requested_date', label: 'Requested', listLayout: 'title' },
      { field: 'advice_submitted', label: 'Submitted', listLayout: 'body' },
      { field: 'advice_given_date', label: 'Given Date', listLayout: 'body' },
      { field: 'advice_text', label: 'Advice', multiline: true, listLayout: 'body' },
      { field: 'advice_docs_public_urls', label: 'Advice Documents', listLayout: 'body' },
      { field: 'advice_loop_closed', label: 'Loop Closed', listLayout: 'body' },
      { field: 'advice_loop_closed_date', label: 'Closed Date', listLayout: 'body' },
      { field: 'response_to_advice', label: 'Response', multiline: true, listLayout: 'body' },
      { field: 'loop_closing_public_urls', label: 'Response Documents', listLayout: 'body' },
    ] as const,
    rowActions: ['view_in_modal'] as const,
    tableActions: [
      {id: 'initiateVisioningAdvice', label: 'Initiate Visioning Advice'},
      {id: 'concludeVisioningAdvice', label: 'Conclude Visioning Advice'},
      {id: 'reopenVisioningAdvice', label: 'Reopen Visioning Advice'},
      {id: 'abandonVisioningAdvice', label: 'Abandon Visioning Advice'},
      {id: 'initiatePlanningAdvice', label: 'Initiate Planning Advice'},
      {id: 'concludePlanningAdvice', label: 'Conclude Planning Advice'},
      {id: 'reopenPlanningAdvice', label: 'Reopen Planning Advice'},
      {id: 'abandonPlanningAdvice', label: 'Abandon Planning Advice'},
    ] as const,
  },
  ...
  educatorEvents: {
    title: 'Events',
    orderBy: [{ column: 'registration_date', ascending: false }] as const,
    cardLimit: 50,
    readSource: 'event_attendance',
    columns: [
      { field: 'event_name', label: 'Event Name', lookupTable: 'event_list', listLayout: 'title' },
      { field: 'event_date', label: 'Event Date', listLayout: 'body' },
