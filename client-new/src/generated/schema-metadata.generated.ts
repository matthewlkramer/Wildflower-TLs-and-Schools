  ...
  "public": {
    ...
    "advice": {
      "columns": {
        ...
        "advice_giver_people_id": {
          "schema": "public",
          "table": "advice",
          "column": "advice_giver_people_id",
          "baseType": "string",
          "isArray": false,
          "isNullable": true,
          "enumRef": null,
        ...
        "advice_loop_closed_date": {
          "schema": "public",
          "table": "advice",
          "column": "advice_loop_closed_date",
          "baseType": "string",
          "isArray": false,
          "isNullable": true,
          "enumRef": null,
        ...
        "advice_requested_date": {
          "schema": "public",
          "table": "advice",
          "column": "advice_requested_date",
          "baseType": "string",
          "isArray": false,
          "isNullable": true,
          "enumRef": null,
    ...
    "developer_notes": {
      "columns": {
        ...
        "developer_target_fix_date": {
          "schema": "public",
          "table": "developer_notes",
          "column": "developer_target_fix_date",
          "baseType": "string",
          "isArray": false,
          "isNullable": true,
          "enumRef": null,
    ...
    "email_addresses": {
      "columns": {
        ...
        "people_roles_associations_id": {
          "schema": "public",
          "table": "email_addresses",
          "column": "people_roles_associations_id",
          "baseType": "string",
          "isArray": false,
          "isNullable": true,
          "enumRef": null,
          "references": [
            ...
            {
              "relation": "people_roles_associations",
              "referencedColumns": [
                "id"
              ],
              "isOneToOne": false
    ...
    "people_roles_associations": {
      "columns": {
        ...
        "tl_membership_acknowledgement_date": {
          "schema": "public",
          "table": "people_roles_associations",
          "column": "tl_membership_acknowledgement_date",
          "baseType": "string",
          "isArray": false,
          "isNullable": true,
          "enumRef": null,
        ...
        "tl_membership_acknowledgement_doc": {
          "schema": "public",
          "table": "people_roles_associations",
          "column": "tl_membership_acknowledgement_doc",
          "baseType": "string",
          "isArray": false,
          "isNullable": true,
          "enumRef": null,
    ...
    "school_ssj_data": {
      "columns": {
        ...
        "planning_advice_loop_closed": {
          "schema": "public",
          "table": "school_ssj_data",
          "column": "planning_advice_loop_closed",
          "baseType": "boolean",
          "isArray": false,
          "isNullable": true,
          "enumRef": null,
        ...
        "visioning_advice_loop_closed": {
          "schema": "public",
          "table": "school_ssj_data",
          "column": "visioning_advice_loop_closed",
          "baseType": "boolean",
          "isArray": false,
          "isNullable": true,
          "enumRef": null,
    ...
    "schools": {
      "columns": {
        ...
        "membership_agreement_version": {
          "schema": "public",
          "table": "schools",
          "column": "membership_agreement_version",
          "baseType": "string",
          "isArray": false,
          "isNullable": true,
          "enumRef": null,
        ...
        "membership_revoked_date": {
          "schema": "public",
          "table": "schools",
          "column": "membership_revoked_date",
          "baseType": "string",
          "isArray": false,
          "isNullable": true,
          "enumRef": null,
        ...
        "signed_membership_agreement_date": {
          "schema": "public",
          "table": "schools",
          "column": "signed_membership_agreement_date",
          "baseType": "string",
          "isArray": false,
          "isNullable": true,
          "enumRef": null,
