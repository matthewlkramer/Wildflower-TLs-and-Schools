...
async function buildApp() {
  ...
  // Public route: list mounted routes without requiring auth. Useful to verify
  // that the bundled server has registered its endpoints in production.
  app.get('/api/_routes-public', (_req, res) => {
    try {
      const routes: any[] = [];
