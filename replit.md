...
- July 06, 2025. Updated school summary tab: removed city/state field, removed all section headers (Location, School Information), and fixed public funding to display linked multi-select publicFundingSources field instead of boolean publicFunding field
