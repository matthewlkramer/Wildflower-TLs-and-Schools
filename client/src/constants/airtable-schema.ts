...
// === Marketing assets ===
export const MARKETING_ASSETS_FIELDS = {
  ID: "ID",
  School: "School",
  Type: "Type",
  Asset: "Asset",
...
export const MARKETING_ASSETS_OPTIONS_TYPE: string[] = [
  "Photo",
  "Visual asset"
];
...
export const EMAILS_FIELDS = {
  ...
  Attachments: "Attachments",
  Educators: "Educators",
  Gmail_msg_ID: "Gmail msg ID",
  Schools: "Schools",
  CC: "CC",
  Matched_Emails: "Matched Emails",
  User: "User",
...
// === Email Sync Errors ===
export const EMAIL_SYNC_ERRORS_FIELDS = {
...
// === Advice Process ===
export const ADVICE_PROCESS_FIELDS = {
  advice_process_blocks_id: "advice_process_blocks_id",
  Step: "Step",
  action_id: "action_id",
  buttonText: "buttonText",
  adviceType: "adviceType",
} as const;
export const ADVICE_PROCESS_OPTIONS_STEP: string[] = [
  "Preliminary",
  "Full"
];
export const ADVICE_PROCESS_OPTIONS_ADVICETYPE: string[] = [
  "programblock"
];

// === Automations ===
export const AUTOMATIONS_FIELDS = {
  ...
  Which_field: "Which field",
  Script: "Script",
  Active: "Active",
  old_Script: "old Script",
  Full_Script: "Full Script",
  Link_to_Overall_Reusable_Code: "Link to Overall Reusable Code",
  code_header__from_Link_to_Overall_Reusable_Code_: "code header (from Link to Overall Reusable Code)",
  Section: "Section",
  Script_with_title: "Script with title",
} as const;
export const AUTOMATIONS_OPTIONS_TRIGGER_EVENT: string[] = [
...
export const AUTOMATIONS_OPTIONS_ACTION: string[] = [
  "Run a script",
  "Action",
  "Update record",
  "Find records & update",
...
export const AUTOMATIONS_OPTIONS_WHICH_TABLE: string[] = [
  "Schools",
  "Educators",
  "School Locations",
  "Which table",
...
export const AUTOMATIONS_OPTIONS_SECTION: string[] = [
  "Data Workflow/Management",
  "Backups + Snapshots",
  "Notifications",
  "Grant initiation",
  "Deduplication",
  "Processing Get Involved Forms",
  "Update School Errors",
  "Buttons",
...
// === Reusable Code ===
export const REUSABLE_CODE_FIELDS = {
  Name: "Name",
  async: "async",
  ...
  Group: "Group",
  function_call_commented: "function call commented",
  Last_modified_time: "Last modified time",
} as const;
export const REUSABLE_CODE_OPTIONS_GROUP: string[] = [
  "DateTime",
  "Slack",
  "Zapier",
  "Geo",
...
// === Overall Reusable Code ===
export const OVERALL_REUSABLE_CODE_FIELDS = {
  Name: "Name",
  Functions: "Functions",
  function_text__from_Reusable_Code_: "function text (from Reusable Code)",
  code_header: "code header",
  function_list: "function_list",
  Automations: "Automations",
  automations_scripts: "automations scripts",
  Last_reusable_code_modification: "Last reusable code modification",
  Last_automation_modification: "Last automation modification",
  recId: "recId",
  LastCodeMod: "LastCodeMod",
} as const;

// === Key Value Pairs ===
export const KEY_VALUE_PAIRS_FIELDS = {
  Key: "Key",
  Value: "Value",
  Description: "Description",
  Owner: "Owner",
...
export const ROADMAP_FIELDS = {
  ...
  Requestor: "Requestor",
  Priority: "Priority",
  Responsible_for_fixing: "Responsible for fixing",
  Target_fix_date: "Target fix date",
  Direction_for_developer: "Direction for developer",
  Circle: "Circle",
  Role: "Role",
  Status: "Status",
  Notes: "Notes",
...
export const ROADMAP_OPTIONS_PRIORITY: string[] = [
  "Top",
  "Medium",
  "Low"
];
export const ROADMAP_OPTIONS_CIRCLE: string[] = [
  "Foundation Ops",
  "School Support",
...
export const ROADMAP_OPTIONS_STATUS: string[] = [
  "Not yet started",
  "In progress",
  "Paused",
  "Complete"
